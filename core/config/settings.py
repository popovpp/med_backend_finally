...
# Cache
REDIS_CONN_STR = os.environ.get('REDIS_HOST', default='redis')
# Время хранения записей в Редис
EXP_TIME_FOR_FLASH_CALL_DATA = 300
EXP_TIME_FOR_ORACLE_PROC_RESULT = 180
EXP_TIME_FOR_EMAIL_DATA = 86400 #Сутки
EXP_TIME_FOR_GUEST_CART_RECORD = 7200 #2часа
EXP_TIME_FOR_SUBSCRIBE_NET_DATA=7200 # 2 часа
EXP_TIME_FOR_CACHE=900 # 15 мин
EXP_TIME_FOR_TIME_MARKER=60
...
PROJECT_TITLE = 'Core'
PROJECT_DESCRIPTION = '''
Core is package for Patient personal area
'''
...
# Services parameters
SUBSCRIBE_PAYMENT_SERVICE_CLIENT_SERVICE_CODE = '11.00'
ADVANCE_PAYMENT_SERVICE_CLIENT_SERVICE_CODE = '11.02.03'
...
# SMB parameters
SMB_SERVER_IP = os.environ.get('SMB_SERVER_IP', default='192.168.1.1')
SMB_USERNAME = os.environ.get('SMB_USERNAME', default='username')
SMB_PASSWORD = os.environ.get('SMB_PASSWORD', default='password')
SMB_SHARED_FOLDER = os.environ.get('SMB_SHARED_FOLDER', default='shared_folder')


# Контакты службы технической поддержки
SUPPORT_PHONE = '71111111111'
SUPPORT_EMAIL = 'support@test.ru'


# Константы времен ожидания
WAITING_CONFIRMING_PAYMENT_PERIOD = 900
TEMPORARY_PAYMENTS_CLEAN_INTERVAL=60.0
GETTING_REGISTRATION_RECEIPT_INTERVAL=130
SENDING_DOCUMENT_REQUEST_INTERVAL = 300

# Oracle ip
ORACLE_IP = '192.168.100.212'
