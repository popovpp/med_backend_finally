...
ALTER TABLE "users_services_schedules" ADD CONSTRAINT "users_services_schedules_fk4" FOREIGN KEY ("user_payment_id") REFERENCES "users_payments"("id");
...
ALTER TABLE "prices" ADD CONSTRAINT "prices_fk4" FOREIGN KEY ("price_type_id") REFERENCES "prices_types"("id");
