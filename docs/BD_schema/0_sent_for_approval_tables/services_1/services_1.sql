...
CREATE TABLE "public.sevices_places_types" (
	"id" serial NOT NULL,
	"client_splace_type_id" integer,
	"name" varchar(100) NOT NULL UNIQUE,
	"description" varchar(500),
	"is_active" bool NOT NULL,
	CONSTRAINT "sevices_places_types_pk" PRIMARY KEY ("id")
) WITH (
  OIDS=FALSE
);
...
ALTER TABLE "services" ADD CONSTRAINT "services_fk0" FOREIGN KEY ("service_place_type_id") REFERENCES "sevices_places_types"("id");
ALTER TABLE "services" ADD CONSTRAINT "services_fk1" FOREIGN KEY ("service_type_id") REFERENCES "services_types"("id");
